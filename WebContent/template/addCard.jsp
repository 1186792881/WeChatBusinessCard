...
<body>
	...
	<section class="container-fluid">
		<form id="saveCard" method="post" role="form" action="${pageContext.request.contextPath }/businesscard/myCard/addCard">
		<input type="hidden" name="cardInfo.openid" value="${openid }">
		      ...
		      <div class="panel-body">
		      	<div class="form-group">
			        <div class="input-group input-group-xs">
	         			...
	         			<input type="text" class="form-control" name="cardInfo.name" placeholder="请输入姓名">
	      			</div>
      			</div>
      			<div class="form-group">
      				<div class="input-group input-group-xs">
         				<span class="input-group-addon danger">公司</span>
         				<input type="text" class="form-control" name="cardInfo.company" placeholder="请输入公司">
      				</div>
      			</div>
      			<div class="form-group">
	      			<div class="input-group input-group-xs">
	         			<span class="input-group-addon danger">职位</span>
	         			<input type="text" class="form-control" name="cardInfo.position" placeholder="请输入职位">
	      			</div>
      			</div>
      			<div class="form-group">
	      			<div class="input-group input-group-xs">
	         			<span class="input-group-addon danger">手机</span>
	         			<input type="tel" class="form-control" name="cardInfo.phone" placeholder="请输入手机">
	      			</div>
      			</div>
      			<div class="form-group">
	      			<div class="input-group input-group-xs">
	         			<span class="input-group-addon danger">邮箱</span>
	         			<input type="email" class="form-control" name="cardInfo.email" placeholder="请输入邮箱">
	      			</div>
      			</div>
		      </div>
		    </div>
		      ...
		      <div class="panel-body">
		      	<div class="form-group">
			        <div class="input-group input-group-xs">
	         			...
	         			<input type="text" class="form-control" name="cardInfo.qq" placeholder="请输入QQ号">
	      			</div>
      			</div>
      			<div class="form-group">
	      			<div class="input-group input-group-xs">
	         			<span class="input-group-addon">微信</span>
	         			<input type="text" class="form-control" name="cardInfo.wechatnumber" placeholder="请输入微信号">
	      			</div>
      			</div>
		      </div>
		    </div>
		      ...
		      <div class="panel-body">
		      	<div class="form-group">
			    	<div class="input-group input-group-xs">
	         			...
	         			<input type="text" class="form-control" name="cardInfo.site" placeholder="请输入公司网址">
	      			</div>
      			</div>
      			<div class="form-group">
	      			<div class="input-group input-group-xs">
	         			<span class="input-group-addon">电话</span>
	         			<input type="tel" class="form-control" name="cardInfo.telphone" placeholder="请输入公司电话">
	      			</div>
      			</div>
      			<div class="form-group">
	      			<div class="input-group input-group-xs">
	         			<span class="input-group-addon">地址</span>
	         			<input type="text" class="form-control" name="cardInfo.address" placeholder="请输入公司地址">
	      			</div>
      			</div>
      			<div class="form-group">
	      			<div class="input-group input-group-xs">
	         			<span class="input-group-addon">传真</span>
	         			<input type="text" class="form-control" name="cardInfo.fax" placeholder="请输入公司传真">
	      			</div>
      			</div>
		      </div>
		    </div>
